...
contract IsValidCodeTest is BuilderCodesTest {
    ...
    function test_isValidCode_false_emptyCode(address /* initialOwner */, address /* initialPayoutAddress */) public view {
    ...
    function test_isValidCode_true_singleCharacter(address /* initialOwner */, address /* initialPayoutAddress */) public view {
    ...
    function test_isValidCode_true_32Characters(address /* initialOwner */, address /* initialPayoutAddress */) public view {
    ...
    function test_isValidCode_true_underscores(address /* initialOwner */, address /* initialPayoutAddress */) public view {
    ...
    function test_isValidCode_true_numericOnly(address /* initialOwner */, address /* initialPayoutAddress */) public view {
        assertTrue(builderCodes.isValidCode("1234567890"));
    }

    /// @notice Test that isValidCode returns true for alphabetic only code
    function test_isValidCode_true_alphabeticOnly(address /* initialOwner */, address /* initialPayoutAddress */) public view {
